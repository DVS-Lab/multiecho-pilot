...
# ppi phys regressor
3dLMEr -prefix ${maindir}/derivatives/fsl/LME_output_ppi-zstat17 \
      -jobs 8 \
...
3dFWHMx -input LME_output_ppi-zstat17+tlrc'[6]'         -mask brain_mask.nii.gz         -acf > acf_3way.txt
3dFWHMx -input LME_output_ppi-zstat17+tlrc'[8]' -mask brain_mask.nii.gz -acf > acf_MB3_vs_MB1.txt
3dFWHMx -input LME_output_ppi-zstat17+tlrc'[12]' -mask brain_mask.nii.gz -acf > acf_ME4_vs_ME1.txt
3dFWHMx -input LME_output_ppi-zstat17+tlrc'[1]' -mask brain_mask.nii.gz -acf > acf_MB_main.txt
3dFWHMx -input LME_output_ppi-zstat17+tlrc'[2]' -mask brain_mask.nii.gz -acf > acf_ME_main.txt
3dFWHMx -input LME_output_ppi-zstat17+tlrc'[6]' -mask brain_mask.nii.gz -acf > acf_3way.txt
3dFWHMx -mask brain_mask.nii.gz -acf -input LME_output_ppi-zstat13+tlrc'[8]' > acf_MB3_vs_MB1_zstat13.txt
3dFWHMx -mask brain_mask.nii.gz -acf -input LME_output_ppi-zstat13+tlrc'[10]' > acf_MB6_vs_MB1_zstat13.txt
3dFWHMx -mask brain_mask.nii.gz -acf -input LME_output_ppi-zstat13+tlrc'[12]' > acf_ME4_vs_ME1_zstat13.txt
3dFWHMx -mask brain_mask.nii.gz -acf -input LME_output_ppi-zstat13+tlrc'[14]' > acf_HC_vs_20ch_zstat13.txt
...
3dinfo -verb LME_output_act-zstat13+tlrc.HEAD
...
3dClustSim -mask brain_mask.nii.gz \
           ...
           -prefix ClustSim_act_zstat13 \
           -pthr 0.05 -athr 0.00714


# main effects and interactions
# HC main effect
3dClusterize -inset LME_output_act-zstat13+tlrc \
