    ...
    if [ -d "$subj_dir" ]; then
        ...
        for sub_dir in "$subj_dir"/*/; do
            ...
            if [ -d "$sub_dir" ]; then
                ...
                cat "$sub_dir/_outcome_computer_reward.txt" \
                    "$sub_dir/_outcome_computer_punish.txt" \
                    "$sub_dir/_outcome_computer_neutral.txt" | \
                ...
                cat "$sub_dir/_outcome_stranger_reward.txt" \
                    "$sub_dir/_outcome_stranger_punish.txt" \
                    "$sub_dir/_outcome_stranger_neutral.txt" | \
